...
let drawEntity = function() {
    function drawPoly(context, centerX, centerY, radius, sides, widthHeightRatio, ratio, scale) {
        ...
        case 0:
            ...
            break;
        case 102:
            for (let[scale,theta] of [[1, 0], [1, .4 * Math.PI], [1, .8 * Math.PI], [-0.1, 0], [1, 1.2 * Math.PI], [1, 1.6 * Math.PI]])
        ...
        default:
            if (sides < 0) {
                ...
                if (sides === 4 && widthHeightRatio != null && (widthHeightRatio[0] !== 1 && widthHeightRatio[1] !== 1)) {
                    for (let[x,y] of [widthHeightRatio, [-widthHeightRatio[0], widthHeightRatio[1]], [-widthHeightRatio[0], -widthHeightRatio[1]], [widthHeightRatio[0], -widthHeightRatio[1]]]) {
                ...
                // Flash Crasher
                for (let[scale,theta] of [[1, 0], [1, .4 * Math.PI], [1, .8 * Math.PI], [0.36, Math.PI / 2], [0.36, -(Math.PI / 2)], [1, 1.2 * Math.PI], [1, 1.6 * Math.PI]])
                    context.lineTo(centerX + radius * scale * Math.cos((angle - .025) + theta), centerY + radius * scale * Math.sin((angle - .025) + theta));
            } else if (sides === 107) {
                // Crusher
                for (let[scale,theta] of [[1, 0], [1, .286 * Math.PI], [1, .571 * Math.PI], [0.36, Math.PI / 2], [-0.75, 0], [0.36, -(Math.PI / 2)], [1, 1.429 * Math.PI], [1, 1.714 * Math.PI]])
                ...
                // Destroyer
                for (let[scale,theta] of [[1, 0], [1, Math.PI / 2], [-1.16, -1.047], [-1.3, -0.3], [-0.425, -1.047], [-0.425, 1.047], [-1.3, .3], [-1.16, 1.047], [-1, Math.PI / 2]// [1, (3 / 2) * Math.PI],
                ])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .025)), centerY + radius * scale * Math.sin(angle + (theta - .025)));
            } else if (sides === 113) {
                // Waller
                for (let[scale,theta] of [[1, .611], [1, 1.571], [-1.25, -0.698], [-0.5, -0.698], [-0.5, .698], [-1.25, .698], [1, -1.571], [1, -0.611]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + theta), centerY + radius * scale * Math.sin(angle + theta));
            } else if (sides === 114) {
                // Vis Destructia
                for (let[scale,theta] of [[0.25, .611], [-1, -0.838], [-0.5, -0.436], [0, 0], [-0.5, .436], [-1, .838], [0.25, -0.611]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .025)), centerY + radius * scale * Math.sin(angle + (theta - .025)));
            } else if (sides === 115) {
                // Grouper
                for (let[scale,theta] of [[1, .489], [-1, -1.257], [-0.5, -0.96], [-0.75, 0], [-0.5, .96], [-1, 1.257], [1, -0.489]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + theta), centerY + radius * scale * Math.sin(angle + theta));
            } else if (sides === 116) {
                // Rodrigo's Destroyer Ship
                for (let[scale,theta] of [[1.5, .14], [1.1, .335], [0.75, .593], [0.475, 1.047], [0.517, 1.466], [-0.55, -1.187], [-0.55, -0.838], [-1, -0.419], [-1.2, -0.312], [-1.375, -0.192], [-1.45, -0.087], [-1.45, .087], [-1.375, .192], [-1.2, .312], [-1, .419], [-0.55, .838], [-0.55, 1.187], [0.517, -1.466], [0.475, -1.047], [0.75, -0.593], [1.1, -0.335], [1.5, -0.14]])
                    context.lineTo(centerX + radius * (scale * 1.5) * Math.cos(angle + (theta - .0261)), centerY + radius * (scale * 1.5) * Math.sin(angle + (theta - .0261)));
            } else if (sides === 117) {
                // Frigate
                for (let[scale,theta] of [[1.95, 0], [0.95, .578], [-1, -0.82], [-1.12, -0.715], [-1.32, -0.873], [-2.155, -0.489], [-2.155, .489], [-1.32, .873], [-1.12, .715], [-1, .82], [0.95, -0.578]])
                    context.lineTo(centerX + radius * (scale * .9) * Math.cos(angle + theta), centerY + radius * (scale * .9) * Math.sin(angle + theta));
            } else if (sides === 118) {
                // Blue Runner
                for (let[scale,theta] of [[0.9, 0], [0.625, .698], [-0.35, -1.361], [-0.75, -1.204], [-1, -0.453], [-0.563, -0.559], [-0.563, .559], [-1, .453], [-0.75, 1.204], [-0.35, 1.361], [0.625, -0.698]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .0261)), centerY + radius * scale * Math.sin(angle + (theta - .0261)));
            } else if (sides === 119) {
                // Varp
                for (let[scale,theta] of [[1, 0], [0.75, .559], [-1, -0.89], [-0.938, -0.262], [-0.5, -0.681], [-0.312, 0], [-0.5, .681], [-0.938, .262], [-1, .89], [0.75, -0.559]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .0261)), centerY + radius * scale * Math.sin(angle + (theta - .0261)));
            } else if (sides === 120) {
                // Spiked Runner
                for (let[scale,theta] of [[0.625, 0], [1, .489], [0.313, .576], [0.5, 1.518], [-0.875, -1.03], [-0.375, -0.768], [-0.938, 0], [-0.375, .768], [-0.875, 1.03], [0.5, -1.518], [0.313, -0.576], [1, -0.489]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .0261)), centerY + radius * scale * Math.sin(angle + (theta - .0261)));
            } else if (sides === 121) {
                // Clutter
                for (let[scale,theta] of [[0.438, 0], [1, .681], [0.625, 1.047], [0.438, 1.065], [-0.5, -1.1], [-0.34, -0.698], [-0.75, 0], [-0.34, .698], [-0.5, 1.1], [0.438, -1.065], [0.625, -1.047], [1, -0.681]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .0261)), centerY + radius * scale * Math.sin(angle + (theta - .0261)));
            } else if (sides === 122) {
                for (let[scale,theta] of [[1, 0], [1.315, .331613], [1.315, .715585], [1, 1.0472], [1.315, 1.37881], [1.315, 1.76278], [1, 2.0944], [1.315, 2.42601], [1.315, 2.80998], [1, 3.14159], [1.315, -2.80998], [1.315, -2.42601], [1, -2.0944], [1.315, -1.76278], [1.315, -1.37881], [1, -1.0472], [1.315, -0.715585], [1.315, -0.331613], [1, 0]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + theta + 1.5447), centerY + radius * scale * Math.sin(angle + theta + 1.5447));
            } else if (sides === 123) {
                // Golden Rectangle
                for (let[scale,theta] of [[1, .541], [-1, -0.541], [-1, .541], [1, -0.541]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + theta + 1.5447), centerY + radius * scale * Math.sin(angle + theta + 1.5447));
            } else if (sides === 124) {
                // Ring
                ...
                // Vanguard
                for (let[scale,theta] of [[1, 0], [-1, -0.959], [-0.125, 0], [-1, .959]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .0261)), centerY + radius * scale * Math.sin(angle + (theta - .0261)));
            } else if (sides === 138) {
                // Trapperzoid
                for (let[scale,theta] of [[0.75, .768], [-1, -1.282], [-1, 1.292], [0.75, -0.768]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .0261)), centerY + radius * scale * Math.sin(angle + (theta - .0261)));
            } else if (sides === 139) {
                // Tri-Seeker
                for (let[scale,theta] of [[1, .139], [1, 1.954], [1, 2.234], [1, -2.234], [1, -1.954], [1, -0.139]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .0261)), centerY + radius * scale * Math.sin(angle + (theta - .0261)));
            } else if (sides === 140) {
                ...
                // Boss Shape
                for (let[scale,theta] of [[1, 0], [1, 72], [1, 90], [0.8, 120], [0.6, 125], [0.5, 144], [1, 170], [0.9, 180], [1, 190], [0.5, 216], [0.6, 235], [0.8, 240], [1, 270], [1, 288]])
                ...
                // Boss Shape 2
                for (let[scale,theta] of [[1, 0], [0.905, 5], [0.915, 10], [0.6, 35], [1, 72], [1, 153.5], [0.45, 100], [0.4, 110], [0.1, 120], [0.75, 180], [0.1, 240], [0.4, 250], [0.45, 260], [1, 206.5], [1, 288], [0.6, 325], [0.915, 350], [0.905, 355]])
                    context.lineTo(centerX + radius * scale * Math.cos((theta * Math.PI) / 180 + angle), centerY + radius * scale * Math.sin((theta * Math.PI) / 180 + angle));
            } else if (sides === 144) {
                // Boss Shape 3
                for (let[scale,theta] of [[0.95, 0], [1, 25], [1, 90], [0.6, 146], [0.5, 170], [1, 180], [0.5, 190], [0.6, 214], [1, 270], [1, 335]])
                    context.lineTo(centerX + radius * scale * Math.cos((theta * Math.PI) / 180 + angle), centerY + radius * scale * Math.sin((theta * Math.PI) / 180 + angle));
            } else if (sides === 145) {
                ...
                // long boy
                for (let[scale,theta] of [[12, 0], [1, 120], [1, 240]])
                    context.lineTo(centerX + radius * scale * Math.cos((theta * Math.PI) / 180 + angle), centerY + radius * scale * Math.sin((theta * Math.PI) / 180 + angle));
            } else if (sides === 148) {
                // Golden Rectangle rot
                for (let[scale,theta] of [[1.2, .541 + Math.PI], [-1.2, -0.541 + Math.PI], [-1.2, .541 + Math.PI], [1.2, -0.541 + Math.PI]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .0261)), centerY + radius * scale * Math.sin(angle + (theta - .0261)));
            } else if (sides === 149) {
                // Semicircle
                ...
                // Explosive Crusher
                for (let[scale,theta] of [[1, 0], [1, 1.11], [-1.1, -.965], [-.46, -.85], [-.824, 0], [-.46, .85], [-1.1, .965], [1, -1.11]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .0261)), centerY + radius * scale * Math.sin(angle + (theta - .0261)));
            } else if (sides === 151) {
                // Dasher
                for (let[scale,theta] of [[1, 0], [1, 2.09], [-.6, -.588], [-1, 0], [-.6, .588], [1, -2.09]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .0261)), centerY + radius * scale * Math.sin(angle + (theta - .0261)));
            } else if (sides === 152) {
                // Red Runner 3
                for (let[scale,theta] of [[1, 0], [1, 2.09], [-.39, -.89], [-.5, 0], [-.39, .89], [1, -2.09]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .0261)), centerY + radius * scale * Math.sin(angle + (theta - .0261)));
            } else if (sides === 153) {
                // Red Runner 4
                for (let[scale,theta] of [[1, 0], [1, 2.09], [-.39, -.89], [-1.08, .5], [-1.08, -0.5], [-.39, .89], [1, -2.09]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .0261)), centerY + radius * scale * Math.sin(angle + (theta - .0261)));
            } else if (sides === 154) {
                // Red Runner 4
                for (let[scale,theta] of [[0.634, .884], [-1, -1.183], [-1, 1.183], [0.634, -0.884]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .0261)), centerY + radius * scale * Math.sin(angle + (theta - .0261)));
            } else if (sides === 155) {
                // Slider
                for (let[scale,theta] of [[1, 0], [0.86, 1.11], [-1, -0.86], [-0.05, 0], [-1, .86], [0.86, -1.11]])
                    context.lineTo(centerX + radius * scale * Math.cos(angle + (theta - .0261)), centerY + radius * scale * Math.sin(angle + (theta - .0261)));
            } else if (sides === 156) {
                // Donut Ring
                context.arc(centerX, centerY, radius, 0, 2 * Math.PI, true);
                ...
                case 10018:
                    ...
                    break;
                case 10019:
                    if (!imageCache.treadmarks || !imageCache.treadmarks.ready)
                        break;
                    context.drawImage(imageCache.treadmarks, -radius, -radius, radius * 2, radius * 2);
                    break;
                case 10020:
                    // This is not a mistake, leave this blank
                    break;
                case 10021:
                    if (!imageCache.seniorpentagon || !imageCache.seniorpentagon.ready)
                        break;
    ...
    function makeGunPath(context, length, height, aspect, skin) {
        ...
        case 2:
            // Scramjet Thruster Base
            context.lineTo(length, h[0]);
            context.lineTo(-length, h[1]);
            context.lineTo(-length, -h[1]);
            context.lineTo(length, -h[0]);
            // Bezier curve
            context.bezierCurveTo(length * 0.25, -h[0] * 0.25, length * 0.25, h[0] * 0.25, length, h[0]);
            break;
        ...
        case 12:
            ...
            context.lineTo(-length, -h[1]);
            context.lineTo(length, -h[0]);
            context.bezierCurveTo(length * 0.5, -h[0] * 0.5, length * 0.5, h[0] * 0.5, length, h[0]);
            break;
    ...
    const drawProp = ( () => {
        function fixRot(xx, yy, angle, x, y) {
            let cos = Math.cos(angle)
              , sin = Math.sin(angle);
            return [x * cos - y * sin + xx, x * sin + y * cos + yy];
        }

        function pointInit(drawSize, m, p, scaleInit, angle) {
            let scale = scaleInit * drawSize / m.size * m.realSize * p.size;
            return [scale * (p.x / p.size + Math.cos(angle)), scale * (p.y / p.size + Math.sin(angle))];
        }

        function drawPropPoints(ctx, xx, yy, rot, drawSize, m, p, scale, angle, c1, c2) {
            let point = pointInit(drawSize, m, p, scale, angle);
            if (c2 !== undefined) {
                ctx.bezierCurveTo(...fixRot(xx, yy, rot, ...c1), ...fixRot(xx, yy, rot, ...c2), ...fixRot(xx, yy, rot, ...point));
            } else if (c1 !== undefined) {
                ctx.quadraticCurveTo(...fixRot(xx, yy, rot, ...pointInit(drawSize, m, p, ...c1)), ...fixRot(xx, yy, rot, ...point));
            } else {
        ...
        return function(ctx, p, pColor, rot, xx, yy, drawSize, m, source) {
            ...
            if (Array.isArray(p.shape)) {
                for (let[x,y,cx1,cy1,cx2,cy2] of p.shape) {
                    drawPropPoints(ctx, xx, yy, finalRot, drawSize, m, p, Math.hypot(x, y), Math.atan2(x, y), cx1 !== undefined ? [Math.hypot(cx1, cy1), Math.atan2(cx1, cy1)] : undefined, cx2 !== undefined ? [Math.hypot(cx2, cy2), Math.atan2(cx2, cy2)] : undefined);
                }
            } else if (typeof p.shape === 'number') {
                if (p.shape > 999) {
                    // Special cases
                    if (p.shape === 1000) {
                        if (!source?.render || !source.widthHeightRatio)
                            return;
                ...
                if (p.shape > 0) {
                    ...
                    for (let i = 0; i < p.shape; i++) {
                        drawPropPoints(ctx, xx, yy, finalRot, size, m, p, 1, (2 * Math.PI / p.shape) * i + Math.PI / p.shape);
                    }
                } else if (p.shape < 0) {
                    // Quadratic curve shapes (like traps)
                    ...
                    for (let i = 0; i < -p.shape; i++) {
                        ...
                        ctx.quadraticCurveTo(...fixRot(p.x + xx, p.y + yy, finalRot, scale * dip * Math.cos(htheta), scale * dip * Math.sin(htheta)), ...fixRot(p.x + xx, p.y + yy, finalRot, scale * Math.cos(theta), scale * Math.sin(theta)));
                    }
                } else {
                    // Circle and other shape: 0 cases
                    ...
                    if (p.isAura) {
                        ...
                        ctx.restore()
                        ctx.restore()
                        // Corresponds to the main ctx.save() at the top
                        return;
                    }
                }
            } else if (path) {
    ...
    return function(x, y, instance, ratio, alpha) {
        ...
        if (config.hideMiniRenders === true && !render.real)
            return;
        ...
        if (instance === global.player.instance)
            global._tankMenuColor = finalColor
        // dont include invuln bc it looks bad
        let invulnTicker = instance.invuln && (Date.now() - instance.invuln) % 200 > 110;
        if (invulnTicker)
            finalColor = mixColors(finalColor, color.vlgrey, .5);

        let adjustedRot = rot;
        if (fade > 0)
            adjustedRot += (((90 * Math.PI) / 180) * (1 - fade)) * Math.sign(rot);
        ...
        if (props.length) {
            for (let i = 0; i < props.length; i++) {
                ...
                if (invulnTicker)
                    pColor = mixColors(pColor, color.vlgrey, .5);
                setColors(currentContext, pColor);
                if (!p.stroke)
                    currentContext.strokeStyle = currentContext.fillStyle;
                if (p.layer === -2)
                    drawProp(currentContext, p, pColor, adjustedRot, tankDrawX, tankDrawY, drawSize, m, source);
            }
        }
        ...
        if (source.guns.length === m.guns.length) {
            ...
            for (let i = 0; i < m.guns.length; i++) {
                ...
                case 1:
                    setColorsUnmix(currentContext, gColor);
                    break;
                case 2:
                    setColorsUnmixB(currentContext, gColor);
                    break;
                case 0:
                case null:
                    setColors(currentContext, gColor);
                    break;
                }
        ...
        if (shadowRelativeColor)
            currentContext.shadowColor = currentContext.strokeStyle;
