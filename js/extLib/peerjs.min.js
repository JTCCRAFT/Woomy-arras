( () => {
    ...
    class s {
        ...
        unpack_string(e) {
            ...
            for (; i < e; )
                ...
                i += 2) : (224 ^ t) < 16 ? (n = (15 & t) << 12 | (63 & r[i + 1]) << 6 | 63 & r[i + 2],
                i += 3) : (n = (7 & t) << 18 | (63 & r[i + 1]) << 12 | (63 & r[i + 2]) << 6 | 63 & r[i + 3],
                i += 4),
    ...
    function ev(e, n) {
        ...
        let r = function(e) {
          ...
          , o = function(e) {
            let t = 65536;
            return "firefox" === n.browser && (t = n.version < 57 ? -1 === e ? 16384 : 2147483637 : n.version < 60 ? 57 === n.version ? 65535 : 65536 : 2147483637),
            t
        }
          , s = function(e, r) {
            let i = 65536;
            ...
            return o.length > 0 ? i = parseInt(o[0].substring(19), 10) : "firefox" === n.browser && -1 !== r && (i = 2147483637),
            i
        }
    ...
    ey.parseRtpParameters = function(e) {
        ...
        for (let r = 3; r < n.length; r++) {
            ...
            if (o) {
                ...
                switch (n.parameters = r.length ? ey.parseFmtp(r[0]) : {},
    ...
    ey.parseRtpEncodingParameters = function(e) {
        ...
        let n = []
          ...
          , c = ey.matchPrefix(e, "a=ssrc-group:FID").map(e => e.substring(17).split(" ").map(e => parseInt(e, 10)));
    ...
    let ew = function({window: e}={}, t={
        ...
        let n = function(e) {
            ...
            t.version = p(n.userAgent, /Firefox\/(\d+)\./, 1)) : n.webkitGetUserMedia || !1 === e.isSecureContext && e.webkitRTCPeerConnection ? (t.browser = "chrome",
    ...
    eN.prototype.removeAllListeners = function(e) {
        ...
        this._events[t] && ez(this, t)) : (this._events = new eB,
        this._eventsCount = 0),
        this
    }
    ,
    ...
    class eV {
        startConnection(e) {
            ...
            if (this.connection.peerConnection = t,
    ...
    class eK {
        _buildRequest(e) {
            ...
            return s.searchParams.set("ts", `${Date.now()}${Math.random()}`),
